...
public class PlayerDamageBossEvent extends Event implements Cancellable {
    ...
    public PlayerDamageBossEvent(EntityDamageByEntityEvent event, Player player, EntityBoss boss) {
